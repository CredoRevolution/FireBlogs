...
<template>
<div class="blog-wrapper" :class="{'no-user': !user}" v-if="post">
  <div class="blog-content">
    <div class="">
      <h2 v-if="post.welcomeScreen !== undefined && post.welcomeScreen">{{post.title}}</h2>
      <h2 v-else>{{post.blogTitle}}</h2>
      <p v-if="post.welcomeScreen !== undefined && post.welcomeScreen">{{post.blogPost}}</p>
      <p v-else class="content-preview" v-html="post.blogHTML"></p>
      <router-link v-if="post.welcomeScreen !== undefined && post.welcomeScreen" class="link link-light" to="#">
        Login/Register
  ...
  <div class="blog-photo">
    <img v-if="post.welcomeScreen !== undefined && post.welcomeScreen" :src="require(`../assets/blogPhotos/${post.photo}.jpg`)" :alt="post.title">
    <img v-else :src="post.blogCoverPhoto" :alt="post.blogTitle || post.title">
  </div>
</div>
</template>
